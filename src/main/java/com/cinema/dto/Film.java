...
public class Film implements Serializable {
    ...
    private Enum<EnumGenereFilm> genereFilmEnum; // F-ficció, A-Aventures, T-Terror, D-dibuixos
    private Integer edatRec; // Edat recomanada.0 Per tots els publics
    ...
    public Film(Integer id, String nom, String sinopsis, String caratula, Enum genereFilmEnum, Integer edatRec, LocalDate dataEstreno) {
        this.id = id;
        this.nom = nom;
        this.sinopsis = sinopsis;
        this.caratula = caratula;
        this.genereFilmEnum = genereFilmEnum;
    ...
    public Enum getGenereFilmEnum() {
        return genereFilmEnum;
    }

    public void setGenereFilmEnum(Enum genereFilmEnum) {
        this.genereFilmEnum = genereFilmEnum;
    }
